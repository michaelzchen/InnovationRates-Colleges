...
# Define UI for application that draws a histogram
    ...
    ui <- navbarPage(
        ...
        tabPanel("Plot",
             # Application title
             titlePanel("Relationship between Admissions Rates and Inventors"),
        ...
        tabPanel("About", 
                 ...
                 p("The first data source comes from Raj Chetty's Opportunity Insights data, which harnesses 
                   ...
                   and impacts of teacher, please visit this link: https://opportunityinsights.org/data/"),
                 h3("Dataset 2 Used"),
                 p("The other dataset I use is from the College Scorecard project - this is designed to increase 
                   ...
                   its data sources, please visit this link: https://collegescorecard.ed.gov/data/"),
                 h3("About Me"),
                 ...
                 mentality among our students. My github repo for this project can be accessed at this link:
                 https://github.com/michaelzchen/finalproject.git. You can reach me at: chen_michael@college.harvard.edu 
                 or on Linkedin: https://www.linkedin.com/in/michael-c-134086135/")))
